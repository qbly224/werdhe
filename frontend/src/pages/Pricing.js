...
var PLANS = [
  {
    ...
    features: [
      { label: 'Jusqu\'à 20 logements',             ok: true  },
      { label: 'Candidatures et dossiers en ligne',  ok: true  },
      { label: 'Mobile Money + Espèces',            ok: true  },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Support email dédié',         ok: true  },
      { label: 'Formation et onboarding équipe',     ok: true  },
      { label: 'Tableau de bord agence centralisé',  ok: true  },
    ]
  },
];
    ...
    <div style={{ fontFamily: 'system-ui, sans-serif', background: '#F7F8F7', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto 48px', padding: '0 20px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 16, overflow: 'hidden', boxShadow: '0 2px 10px rgba(0,0,0,0.06)' }}>
          ...
          {[
            { label: 'Logements gérés',           vals: ['20', '∞']           },
            { label: 'Candidatures dossiers',     vals: [true, true]           },
            { label: 'Mobile Money (Orange/MTN)', vals: [true, true]           },
            { label: 'Documents PDF auto',        vals: [true, true]           },
            { label: 'Alertes loyers auto',       vals: [true, true]           },
            { label: 'Rapports financiers',       vals: [true, true]           },
            { label: 'Export CSV + PDF',          vals: [true, true]           },
